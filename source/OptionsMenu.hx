...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCatagory> = [
		new OptionCatagory("ZADRY", [
			new MemeOption("dumb menu screen things"),
			new Downloads("disable the thing where it downloads a dumb mp3 when beating foolhardy again"),
			new CustomMusic("disable the other zadry music, and makes it only the funny zardy song"),
			new Shake("for whenever zadry shakes the screen lol"),
		]),
	...
	{
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('zadry-bg'));
