	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'mom':
				...
				playAnim('idle');
			case 'zadry':
				// WHY THE HELL DID I MAKE THIS LMAO
				tex = Paths.getSparrowAtlas('zadry_real');
				frames = tex;
	
				animation.addByPrefix('idle', "zadry idle", 24, false);
				animation.addByPrefix('singUP', "zadry up", 24, false);
				animation.addByPrefix('singDOWN', "zadry down", 24, false);
				animation.addByPrefix('singLEFT', 'zadry left', 24, false);
				animation.addByPrefix('singRIGHT', 'zadry right', 24, false);
	
				addOffset('idle');
				addOffset("singUP", 0, 180);
				addOffset("singRIGHT");
				addOffset("singLEFT", 70, 0);
				addOffset("singDOWN", 20, 36);
	
				playAnim('idle');
			case 'olopep':
				tex = Paths.getSparrowAtlas('robotstage/olopep');
				frames = tex;
				...
				addOffset("singLEFT", 260, 0);
				addOffset("singDOWN", 90, 60);
