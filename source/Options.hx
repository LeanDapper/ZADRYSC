...
class Downloads extends Option
{
	...
	{
		FlxG.save.data.downloads = !FlxG.save.data.downloads;
		display = updateDisplay();
		return true;
	}
	...
	{
		return "Downloads: " + (!FlxG.save.data.downloads ? "FALSE" : "ACTIVE");
	}
}
...
class Shake extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.shakezadry = !FlxG.save.data.shakezadry;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Shake Screen: " + (!FlxG.save.data.shakezadry ? "NO" : "YES");
	}
}

class CustomMusic extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.noMusic = !FlxG.save.data.noMusic;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "ZADRY CUSTOM MUSIC: " + (!FlxG.save.data.noMusic ? "TRUE" : "FALSE");
	}
}

class MemeOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.sans = !FlxG.save.data.sans;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "MEME OCCURRENCES " + (!FlxG.save.data.sans ? "FALSE" : "TRUE");
	}
}
